...
saves the state of your source code at various points in time. This allows
a developer to track the historical changes in contents of files over time.

It's distributed nature means everyone working on a project has their own
separate offline copy of all of the code history allowing folks to work on
the same project in parallel and occassionally syncing up with each other.
